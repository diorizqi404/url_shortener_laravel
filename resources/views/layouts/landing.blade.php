...
<body class="flex justify-center items-center mt-24 flex-col">
    <h1 class="font-bold text-blue-400 text-2xl sm:text-4xl">🔗FREE URL SHORTENER✨</h1>
    <h2 class="font-medium text-slate-500 text-xl w-[90%] lg:w-1/2 md:text-2xl text-center mt-2">UBAH <span class="text-blue-500 underline">URL</span> <span class="tracking-widest">PANJANG</span> MENJADI <span class="tracking-tighter">PENDEK</span> DAN MUDAH DIINGAT DENGAN FREE URL SHORTENER DARI {{ $domain }}😎</h2>
    <div class="px-4 py-2 border-2 border-blue-600 rounded-lg flex flex-wrap my-4 w-[90%] md:w-auto">
